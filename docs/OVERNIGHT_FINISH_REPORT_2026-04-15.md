...
- The current native build was archived successfully and installed on Skyler’s iPhone over the local device tunnel.
...
- The app installed to Skyler’s iPhone successfully, but remote launch failed because the phone was locked during the launch attempt.
