...
Adair Forsythe HR source templates live in:

`/<path>/Library/CloudStorage/GoogleDrive-hayden.ellison42@example.com/Shared drives/1 - Luxury Pet Hotel Investments LLC/7 - Operations/Adair Forsythe/Performance Reviews`
...
`/<path>/Documents/Codex/business-logic/performance-reviews/pdf-field-verification`
