...
- The Cherry Hill PDF is scan-based and still needs OCR/manual QA for exact page-to-section mapping, but the bathing, written, and live certification families are now seeded as editable templates.
