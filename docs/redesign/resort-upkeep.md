...
- **A hardcoded escalation contact** ("Mike Williams", a personal phone number and email) is baked into the Troubleshooting panel rather than being a location setting.
