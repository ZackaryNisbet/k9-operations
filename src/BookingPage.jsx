            ...
            {regStep === 0 && (
              <div>
                ...
                <div style={{ marginBottom: 16 }}>
                  <BkInput label="Address" required value={client.address} onChange={e => setClient({ ...client, address: e.target.value })} placeholder="123 Main St, Stamford, CT 06901" />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                  <BkInput label="Emergency Contact" required value={client.emergencyContact} onChange={e => setClient({ ...client, emergencyContact: e.target.value })} placeholder="John Smith" />
