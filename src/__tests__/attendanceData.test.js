...
describe("attendanceData helpers", () => {
  it("summarizes active-employee attendance counts for all time and last 30 days", () => {
    const laborEmployees = [
      { id: "emp-1", full_name: "Alex Vance", position_title: "CSR", start_date: "2026-01-01", end_date: null },
    ...
    expect(summary.rows[0].full_name).toBe("Alex Vance");
  ...
  it("plans legacy attendance import with name matching, creates, skips, and unmatched rows", () => {
    const plan = planLegacyAttendanceImport({
      legacyRoster: [
        { id: "r-1", name: "Alex Vance", title: "CSR", startDate: "2026-02-01" },
        { id: "r-2", name: "Jordan Lee", title: "PCT", startDate: "2026-03-10" },
      ],
      legacyEntries: [
        { id: "e-1", name: "Alex Vance", type: "Tardy", date: "2026-04-10", coverage: "No", notes: "Late by 12 minutes" },
        ...
        { id: "e-4", name: "Alex Vance", type: "Unknown Type", date: "2026-04-11" },
        { id: "e-5", name: "Alex Vance", type: "Tardy", date: "2026-04-12" },
      ],
      laborEmployees: [
        { id: "emp-1", full_name: "Alex Vance" },
      ],
    ...
    expect(plan.unmatchedEntries).toEqual([
      ...
      { id: "e-4", name: "Alex Vance", type: "Unknown Type", reason: "incident_type_not_mapped" },
    ]);
