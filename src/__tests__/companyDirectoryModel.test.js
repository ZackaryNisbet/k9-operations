...
const people = [
  { id: "alan", display_name: "Peyton Hale", title: "Co-CEO", directory_status: "active", department: "Executive", locations: [] },
  { id: "lia", display_name: "Skyler Carter", title: "COO", directory_status: "active", department: "Operations", locations: [] },
  { id: "sean", display_name: "Harper Sterling", title: "VP Resort Operations", directory_status: "active", department: "Operations", locations: [] },
...
describe("company directory canonical org model", () => {
  it("maps Supabase people and reports_to edges into Balkan id/pid nodes", () => {
    ...
    expect(lia).toMatchObject({ id: "person:lia", pid: "person:alan", name: "Skyler Carter" });
    expect(sean).toMatchObject({ id: "person:sean", pid: "person:lia", name: "Harper Sterling" });
  });
  ...
  it("uses partner render metadata for secondary co-leader edges without changing reports_to", () => {
    const nodes = toBalkanNodes({
      people: [
        ...people,
        { id: "phil", display_name: "Sage Vance", title: "Co-CEO", directory_status: "active", department: "Executive", locations: [] },
      ],
      edges: [
        { id: "e1", parent_person_id: "alan", child_person_id: "lia", relationship_type: "reports_to", is_primary: true },
