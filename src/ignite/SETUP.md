...
const lead = { email: 'sarah.johnson@gmail.com', phone: '(856) 555-0142', firstName: 'Casey', lastName: 'Johnson' };
const clients = [
  { id: '1', email: 'sarah.johnson@gmail.com', phone: '8565550142', firstName: 'Casey', lastName: 'Johnson' },
  { id: '2', email: 'mike@example.com', phone: '5551234567', firstName: 'Michael', lastName: 'Vance' },
];
...
Incoming Lead
  ...
  │    b. Nickname lookup (Hayden↔Michael, Jen↔Jennifer, etc.)
...
- Hayden/Haydeny/Mick → Michael
- Jen/Jenny/Jenn → Jennifer
- Bob/Rob/Bobby → Robert
- Bill/Will/Billy → William
- etc.

This means a lead from "Hayden Johnson" will match a client named "Michael Johnson" with high confidence.
