...
export const SAMPLE_WEB_FORM_EMAIL = {
  subject: 'New Web Form Submission - K9 Operations Cherry Hill',
    ...
    <div style="padding: 20px;">
      <table style="width: 100%; border-collapse: collapse;" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td style="padding: 8px 0; border-bottom: 1px solid #eee;" data-field="first_name">Sarah</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="padding: 8px 0; border-bottom: 1px solid #eee;" data-field="message">I'd like to schedule a tour for my dog Max. We just moved to the Cherry Hill area.</td>
        </tr>
      </table>
...
export const SAMPLE_PHONE_CALL_EMAIL = {
  subject: 'New Phone Call Lead - K9 Operations Cherry Hill',
  from: 'noreply@leads.idigitalstrategies.com',
  html: `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"></head>
...
export const SAMPLE_AD_CLICK_EMAIL = {
  subject: 'New Ad Click Lead - K9 Operations Cherry Hill',
  from: 'noreply@leads.idigitalstrategies.com',
  html: `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"></head>
  ...
  <div style="max-width: 600px; margin: 0 auto; background: #fff; border-radius: 8px; overflow: hidden;">
    ...
    <div style="padding: 20px;">
      <table style="width: 100%; border-collapse: collapse;" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td style="padding: 8px 0; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Last Name</td>
          <td style="padding: 8px 0; border-bottom: 1px solid #eee;" data-field="last_name">Martinez</td>
        </tr>
        <tr>
          <td style="padding: 8px 0; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Email</td>
