  ...
  return (
    <Modal title="Quick Add Client" onClose={onClose}>
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <Inp label="Notes" type="textarea" value={notes} onChange={setNotes} placeholder="e.g., Met at Cherry Hill Dog Park, has a Golden named Max" rows={2} />
      ...
      <div style={{
        ...
        <div style={{ padding: "24px 28px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <Inp label="Notes" type="textarea" value={notes} onChange={setNotes}
            placeholder="e.g., Met at Cherry Hill Dog Park, has a Golden named Max" rows={3} />
