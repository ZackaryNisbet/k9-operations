        ...
        <Modal title={editingId ? "Edit Resource" : "Add Resource"} onClose={() => { setShowModal(false); resetForm(); }}>
          <div style={{ display: "grid", gap: 14 }}>
            <label style={{ display: "grid", gap: 6 }}>
              ...
              <input value={title} onChange={(event) => setTitle(event.target.value)} placeholder="Cherry Hill operations SOP" style={{ padding: "11px 12px", borderRadius: 10, border: `1px solid ${C.border}`, fontSize: 14, fontFamily: "inherit" }} />
            </label>
            <label style={{ display: "grid", gap: 6 }}>
