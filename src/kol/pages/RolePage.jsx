...
const WORKFLOW_CARDS = [
  ...
  { id: "roll_call_opening", label: "Opening Roll Call", icon: "Users", routeTo: "ops-roll-call-opening", typeSub: "roll_call_opening" },
  { id: "roll_call_closing", label: "Closing Roll Call", icon: "Users", routeTo: "ops-roll-call-closing", typeSub: "roll_call_closing" },
  { id: "roll_call", label: "Closing Roll Call", icon: "Users", routeTo: "ops-roll-call-closing", typeSub: "roll_call_closing" },
  { id: "feeding_meds_am", label: "AM Feeding and Meds", icon: "Heart", routeTo: "ops-feeding-meds-am", typeSub: "feeding_meds_am" },
  { id: "feeding_meds_midday", label: "Midday Feeding and Meds", icon: "Heart", routeTo: "ops-feeding-meds-midday", typeSub: "feeding_meds_midday" },
  { id: "feeding_meds_pm", label: "PM Feeding and Meds", icon: "Heart", routeTo: "ops-feeding-meds-pm", typeSub: "feeding_meds_pm" },
  { id: "feeding_report", label: "Feeding Report", icon: "ClipboardList", routeTo: "ops-feeding-report", typeSub: "feeding_report" },
  ...
  { id: "meds", label: "Medication Report", icon: "Heart", routeTo: "ops-medication-report", typeSub: "medication_report" },
