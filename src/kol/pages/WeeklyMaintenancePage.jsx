...
// Location ID is now always passed via props — no hardcoded default
...
// ─── Main Page ──────────────────────────────────────────────────────────
function WeeklyMaintenancePage({ data, save, nav, profile, addGlobalToast, locationId: propLocationId }) {
  const td = todayStr();
  ...
  const locationId = propLocationId || profile?.location_id || data?.locationId;
