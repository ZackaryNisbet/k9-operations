...
function generateDemoData() {
  ...
  return {
    ...
    attendanceRoster: (() => {
      const demoStaff = [
        { name: "Casey Mitchell", title: "General Manager", phone: "555-100-0001", email: "sarah.mitchell@k9demo.com", startDate: "2024-03-15" },
        ...
        { name: "Taylor Brooks", title: "Supervisor", phone: "555-100-0004", email: "tyler.brooks@k9demo.com", startDate: "2024-09-10" },
        ...
        { name: "Chris Bennett", title: "Pet Care Technician", phone: "555-100-0010", email: "chris.martinez@k9demo.com", startDate: "2025-06-15" },
    ...
    attendanceEntries: (() => {
      const demoEntries = [
        ...
        { name: "Chris Bennett", type: "No Call / No Show", date: "2026-02-14", coverage: "No", notes: "Did not report and did not contact anyone.", loggedBy: "SM" },
        { name: "Chris Bennett", type: "Tardy", date: "2026-02-21", coverage: "No", notes: "8 minutes late.", loggedBy: "TB" },
        { name: "Taylor Brooks", type: "Call Out (2+ hrs)", date: "2026-02-10", coverage: "Yes", notes: "Sick, found coverage from Emily.", loggedBy: "SM" },
