...
const FIRST_POOL = [
  ...
  "Devon", "Ellis", "Finley", "Drew", "Blake", "Cameron", "Quinn", "Peyton",
...
// aggregated calendar emits subtitle "Casey Gonzalez" or title "30-Day Review ·
// Casey Gonzalez"). A key-based scrubber can't see those, so we fake any standalone
