...
const LEAN_PERMISSION_AREAS = [
  ...
  "Inventory Mark Ordered",
  "Inventory Complete Count",
  "Inventory Edit Catalog",
  "Inventory Manage Schedule",
  "Inventory Reopen Count",
  "Dashboard",
  "Financial Reporting",
  "Occupancy Reports",
  "Services Management",
  ...
  "Labor Edit Roster",
  "Labor Attendance",
  "Labor Log Attendance",
  "Labor Interviews",
  "Labor Manage Interviews",
  "Labor Performance Reviews",
  ...
  "Labor Employee Notes",
  "Labor Templates",
  "Checkout TV Access",
  "Checkout TV Settings",
  "Grassroots Access",
...
const LEAN_PERMISSION_CATEGORIES = [
  ...
  { key: "operations", label: "Operations & Daily Work", permissions: [
    ...
    { key: "EOD Reports", label: "EOD Reports", desc: "View end-of-day reports" },
    { key: "Checkout TV Access", label: "Checkout TV", desc: "Open the floor TV view" },
    { key: "Checkout TV Settings", label: "Checkout TV Settings", desc: "Tune local TV display settings from the TV surface" },
  ]},
  { key: "customer", label: "Customers & Photos", permissions: [
    { key: "Customer Lifecycle", label: "Customer Lifecycle", desc: "View and manage customer lifecycle stages, incidents, and client-facing records" },
  ...
  { key: "inventory", label: "Inventory", permissions: [
    ...
    { key: "Inventory Count On Hand", label: "Mark On Hand", desc: "Enter on-hand and in-transit counts" },
    { key: "Inventory Mark Ordered", label: "Mark Ordered", desc: "Mark reorder decisions and skip order decisions" },
    { key: "Inventory Complete Count", label: "Complete Counts", desc: "Submit and lock completed inventory cycles" },
    { key: "Inventory Edit Catalog", label: "Edit Catalog", desc: "Add, edit, reorder, and deactivate catalog items" },
    { key: "Inventory Manage Schedule", label: "Manage Schedule", desc: "Change inventory count cadence and due dates" },
    { key: "Inventory Reopen Count", label: "Mark Incomplete", desc: "Reopen a completed inventory cycle" },
  ]},
  { key: "labor", label: "Labor", permissions: [
    { key: "Labor Management", label: "Labor Access", desc: "Open the Labor Management module" },
    { key: "Labor Roster", label: "Roster", desc: "View labor roster, compliance, and employee records" },
    { key: "Labor Edit Roster", label: "Edit Roster", desc: "Add employees and edit roster identity fields" },
    { key: "Labor Attendance", label: "Attendance", desc: "View attendance marks, summaries, and policy history" },
    { key: "Labor Log Attendance", label: "Log Attendance", desc: "Create, edit, and delete attendance marks and policy actions" },
    { key: "Labor Interviews", label: "Interviews", desc: "View candidate interview records and interview packets" },
    { key: "Labor Manage Interviews", label: "Manage Interviews", desc: "Create interviews and configure interview templates, PDFs, and questions" },
    { key: "Labor Performance Reviews", label: "Legacy Review Records", desc: "Backward-compatible access for configured review records" },
    { key: "Labor Compliance View", label: "Compliance View", desc: "View resolved training and performance review compliance policy and employee status" },
    { key: "Labor Compliance Update Evidence", label: "Update Compliance Evidence", desc: "Upload or update completion evidence for configured labor compliance requirements" },
    { key: "Labor Compliance View PDFs", label: "View Compliance PDFs", desc: "Open uploaded compliance evidence PDFs and generated compliance review PDFs" },
    { key: "Labor Compliance Manage Policy", label: "Manage Compliance Policy", desc: "Create and edit enterprise or location labor compliance policy requirements" },
    { key: "Labor Compliance Historical Cleanup", label: "Historical Compliance Cleanup", desc: "Run audited cleanup or backfill actions for labor compliance history" },
    { key: "Labor Employee Notes", label: "Employee Notes", desc: "View and add manager-facing employee notes" },
    { key: "Labor Templates", label: "Labor Templates", desc: "Create and publish labor training/review templates" },
...
const LEAN_PERMISSION_MATRIX = {
  pct: {
    ...
    "Inventory Count On Hand": false,
    "Inventory Mark Ordered": false,
    "Inventory Complete Count": false,
    "Inventory Edit Catalog": false,
    "Inventory Manage Schedule": false,
    "Inventory Reopen Count": false,
    "Dashboard": true,
    "Financial Reporting": false,
    "Occupancy Reports": false,
    "Services Management": false,
    "Training Management": false,
    "Labor Management": false,
    "Labor Roster": false,
    "Labor Edit Roster": false,
    "Labor Attendance": false,
    "Labor Log Attendance": false,
    "Labor Interviews": false,
    "Labor Manage Interviews": false,
    "Labor Performance Reviews": false,
    "Labor Compliance View": false,
    "Labor Compliance Update Evidence": false,
    "Labor Compliance View PDFs": false,
    "Labor Compliance Manage Policy": false,
    "Labor Compliance Historical Cleanup": false,
    "Labor Employee Notes": false,
    "Labor Templates": false,
    "Checkout TV Access": true,
    "Checkout TV Settings": false,
  ...
  supervisor: {
    ...
    "Inventory Count On Hand": true,
    "Inventory Mark Ordered": true,
    "Inventory Complete Count": true,
    "Inventory Edit Catalog": false,
    "Inventory Manage Schedule": false,
    "Inventory Reopen Count": true,
    "Dashboard": true,
    "Financial Reporting": false,
    "Occupancy Reports": false,
    "Services Management": true,
    "Training Management": true,
    "Labor Management": true,
    "Labor Roster": true,
    "Labor Edit Roster": true,
    "Labor Attendance": true,
    "Labor Log Attendance": true,
    "Labor Interviews": true,
    "Labor Manage Interviews": true,
    "Labor Performance Reviews": true,
    "Labor Compliance View": true,
    "Labor Compliance Update Evidence": true,
    "Labor Compliance View PDFs": true,
    "Labor Compliance Manage Policy": false,
    "Labor Compliance Historical Cleanup": false,
    "Labor Employee Notes": true,
    "Labor Templates": false,
    "Checkout TV Access": true,
    "Checkout TV Settings": true,
  ...
  manager: {
    ...
    "Inventory Mark Ordered": true,
    "Inventory Complete Count": true,
    "Inventory Edit Catalog": true,
    "Inventory Manage Schedule": true,
    "Inventory Reopen Count": true,
    "Dashboard": true,
    ...
    "Labor Compliance Update Evidence": true,
    "Labor Compliance View PDFs": true,
    "Labor Compliance Manage Policy": true,
    "Labor Compliance Historical Cleanup": false,
    "Labor Employee Notes": true,
    "Labor Templates": true,
    "Checkout TV Access": true,
    "Checkout TV Settings": true,
    "Grassroots Access": true,
    "Grassroots Log Activity": true,
  ...
  location_admin: {
    ...
    "Labor Compliance View PDFs": true,
    "Labor Compliance Manage Policy": true,
    "Labor Compliance Historical Cleanup": true,
    "Labor Employee Notes": true,
    "Labor Templates": true,
    "Checkout TV Access": true,
    "Checkout TV Settings": true,
...
const WORKFLOW_SECTION_MAP = {
  pct: {
    ...
    enrichment: "midday",
    ice_cream: "midday",
    roll_call_opening: "opening",
    roll_call_closing: "closing",
    roll_call: "closing",
    emergency_contacts: "as_needed",
    attendance: "opening",
    feeding_meds_am: "opening",
    feeding_meds_midday: "midday",
    feeding_meds_pm: "closing",
    feeding_report: "opening",
    vendor_log: "as_needed",
    re_eval: "opening",
    meds: "opening",
    evaluations: "midday",
  },
