...
const METRIC_DEFINITIONS = [
  ...
  { key: "departing.large_boarding", label: "Large Boarding Departures" },
  { key: "departing.small_boarding", label: "Small Boarding Departures" },
  { key: "departing.private_play_boarding", label: "Private Play Boarding Departures" },
  { key: "departing.half_and_half_boarding", label: "Half and Half Boarding Departures" },
  { key: "departing.evaluation_boarding", label: "Evaluation Boarding Departures" },
  { key: "departing.unclassified_boarding", label: "Unresolved Boarding Departures" },
  { key: "departing.total_boarding", label: "Total Boarding Dogs Departing Today" },
  ...
  { key: "support.total_dog_volume", label: "Daily Dog Volume" },
  { key: "support.total_daily_dog_volume", label: "Total Daily Dog Volume" },
