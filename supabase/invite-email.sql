...
BEGIN
  ...
  email_html := '<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#f4f5f7;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial,sans-serif">'
    ...
    || '<img src="cid:logo" width="40" height="40" alt="K9" style="display:block;border:0" />'
    || '</td>'
    ...
    || '<p style="margin:12px 0 0;text-align:center;font-size:12px;color:#6b7280">Or go to: <a href="https://k9operations.com" style="color:#003462;text-decoration:underline">k9operations.com</a></p>'
    || '</div>'
