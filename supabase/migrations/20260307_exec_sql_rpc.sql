-- exec_sql: Secure RPC function for the AI assistant to run read-only queries.
-- Only SELECT statements are allowed. Enforced at both the function level and
-- the edge function level (defense in depth).
