-- Training Module — Seed Cherry Hill PCT and CSR Training Plans
...
-- ── PCT Cherry Hill Operational Additions ──
...
VALUES (gen_random_uuid(), v_pct_version_id, 'pct_cherry_hill_additions', 'Cherry Hill Operational Additions', 'module', 7, 'observe_participate_demonstrate')
RETURNING id INTO v_section_id;
v_item_seq := 0;
INSERT INTO training_template_items (template_version_id, template_section_id, item_key, label, item_type, sequence_order, completion_mode) VALUES
