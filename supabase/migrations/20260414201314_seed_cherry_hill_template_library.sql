-- Adair Forsythe Certification Template Library Seed
-- Expands the Adair Forsythe packet catalog from placeholder rows into actual seeded
...
BEGIN
  ...
  VALUES (
    ...
    'Seeded from the Adair Forsythe packet map as a pragmatic bathing certification scaffold.',
    jsonb_build_object(
      'seed_version', 'v1',
  ...
  VALUES (
    ...
    'written_certification',
    'K9 CH Certifications.pdf',
    'Seeded from the Adair Forsythe packet map as a pragmatic written certification scaffold.',
    jsonb_build_object(
      'seed_version', 'v1',
  ...
  VALUES (
    ...
    'live_certification',
    'K9 CH Certifications.pdf',
    'Seeded from the Adair Forsythe packet map as a pragmatic live certification scaffold.',
    jsonb_build_object(
      'seed_version', 'v1',
...
SET
  ...
  notes = 'Adair Forsythe master packet for the certification library. The bathing, written, and live families are now seeded as editable templates; exact page-to-section OCR mapping still needs QA.'
