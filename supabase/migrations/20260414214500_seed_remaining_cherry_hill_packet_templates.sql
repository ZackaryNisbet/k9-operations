-- Seed the remaining distinct Adair Forsythe packet families as editable templates
...
BEGIN
  ...
  FROM public.training_seed_ensure_template(
    ...
    'Seeded from Adair Forsythe packet pages 1-2 with dependency-style supervisor readiness requirements.',
    jsonb_build_object(
  ...
  FROM public.training_seed_ensure_template(
    ...
    'gingr_training_guide',
    'K9 CH Certifications.pdf',
    'Seeded from Adair Forsythe packet pages 12-14 as a structured Gingr competency guide.',
    jsonb_build_object(
  ...
  FROM public.training_seed_ensure_template(
    ...
    'customer_service_certification',
    'K9 CH Certifications.pdf',
    'Seeded from Adair Forsythe packet pages 18-23 as a customer service written certification.',
    jsonb_build_object(
  ...
  FROM public.training_seed_ensure_template(
    ...
    'daycare_certification',
    'K9 CH Certifications.pdf',
    'Seeded from Adair Forsythe packet pages 24-27 as a written + live daycare certification.',
    jsonb_build_object(
  ...
  FROM public.training_seed_ensure_template(
    ...
    'daycare_evaluation_certification',
    'K9 CH Certifications.pdf',
    'Seeded from Adair Forsythe packet pages 28-31 as the daycare evaluation certification.',
    jsonb_build_object(
  ...
  FROM public.training_seed_ensure_template(
    ...
    'feeding_medication_certification',
    'K9 CH Certifications.pdf',
    'Seeded from Adair Forsythe packet pages 32-35 as the feeding and medication certification.',
    jsonb_build_object(
  ...
  FROM public.training_seed_ensure_template(
    ...
    'sanitation_certification',
    'K9 CH Certifications.pdf',
    'Seeded from Adair Forsythe packet pages 36-39 as the sanitation certification.',
    jsonb_build_object(
  ...
  FROM public.training_seed_ensure_template(
    ...
    'tour_certification_test',
    'K9 CH Certifications.pdf',
    'Seeded from Adair Forsythe packet pages 40-42 as the tour certification test.',
    jsonb_build_object(
...
SET
  ...
  notes = 'Adair Forsythe training packet normalized into discrete editable training and certification families.'
...
SET
  ...
  notes = 'CSR onboarding training plan from Adair Forsythe packet pages 2-6.'
WHERE source_file_name = 'K9 CH Certifications.pdf'
...
SET
  ...
  qa_flags = '["ocr-assisted family mapping"]'::jsonb,
  notes = 'PCT onboarding training plan from Adair Forsythe packet pages 7-11.'
WHERE source_file_name = 'K9 CH Certifications.pdf'
  AND document_family = 'onboarding_training_plan'
  AND role_scope = 'PCT';
