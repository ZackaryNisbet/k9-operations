...
-- Source workbooks:
-- - /<path>/Downloads/LPHI Directory.xlsx
-- - /<path>/Downloads/Gm Contact List (1).xlsx
...
WITH payload AS (
  ...
  "people": [
    ...
    {
      "directory_status": "active",
      "display_name": "Facilities Vendor",
  ...
  "source_files": {
    "corporate": "/<path>/Downloads/LPHI Directory.xlsx",
    "resorts": "/<path>/Downloads/Gm Contact List (1).xlsx"
  }
}$k9dir$::jsonb AS data
),
locations_input AS (
