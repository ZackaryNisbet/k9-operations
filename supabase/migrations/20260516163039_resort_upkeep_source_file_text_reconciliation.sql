...
VALUES
  (
    ...
    'Contact',
    $$If ever there is a situation where additional guidance is needed, please feel free to reach out to Mike Williams (CDO). In an emergency/same day service situation please call Mike at 623-261-3294. If not an emergency situation please e-mail Mike at mike.williams@k9resorts.com.$$,
    1,
