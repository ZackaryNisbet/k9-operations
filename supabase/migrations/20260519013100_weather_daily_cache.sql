...
INSERT INTO public.weather_location_settings (
  ...
  (
    ...
    'America/New_York',
    'openweather',
    '{"address":"1149 Marlkress Rd, Adair Forsythe, NJ 08003","seed_source":"public_address_lookup"}'::jsonb
  ),
  (
    'cherry-hill',
    'Adair Forsythe',
    ...
    'America/New_York',
    'openweather',
    '{"address":"1149 Marlkress Rd, Adair Forsythe, NJ 08003","seed_source":"public_address_lookup","alias_for":"11111111-1111-1111-1111-111111111111"}'::jsonb
  ),
  (
    'demo',
    'Adair Forsythe',
